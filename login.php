 	...
 	<div class="sign-up-container bottom-50 down-5">
 		...
 		<div class="col-8">
 			<div class="col-8 off-2 down-5">
 				<div class="down-5"><span class="color-code-2 px30"><i class="fas fa-user"></i> Welcome Back</span></div>
 				<div><span class="faded px13">Trust you are doing fine today</span></div>
 				...
 				<div class="mother down-4">
 					<form method="POST" action="helper.php" autocomplete="off">
 						...
 						<div class="mother down-1"><span class="px13 color-code-2">User Email</span></div>
 						...
 						<div class="mother down-2"><span class="px13 color-code-2">User Password</span></div>
 						...
 						<div class="mother down-3"><input type="checkbox" name="agree" required="	"><span class="faded px13">keep me logged in</span></div>
 						<div class="down-1 mother"><span class="color-code-1 px13 bold"><?php 	echo ""; ?></span></div>
 						<div class="mother down-1"><button type="submit" name="sign_up" class="sign_up_btn">Log In</button></div>
 						<div class="centered mother down-1"><span class="faded px13">Forgotten password? <a href="" class="color-code-2 bold">recover password</a></span></div>
 						<div class="centered mother"><span class="faded px13">I don't have an account <a href="signup.php" class="color-code-2 bold">Sign up</a></span></div>
 					</form>
 				</div>
 			</div>
 		</div>
...
<div class="hidden-ls mother bottom-50">
	...
	<div class="bg-landing-login xs-down-20"></div>
	<div class="mother">
		<div class="xs-10 xs-off-1 xs-down-1">
			<div><span class="px25 bold color-code-2"><i class="fas fa-user"></i> Welcome Back</span></div>
			<div class="xs-top-1 xs-12"><span class="px13 faded">Trust you are doing fine today</span></div>
			<div class="mother xs-down-3">
				<form method="POST" action="helper.php">
 						...
 						<div class="mother xs-down-3"><input type="checkbox" name="agree" required="	"><span class="faded px13"> Keep me logged in</span></div>
 						<div class="xs-down-3 mother"><span class="color-code-1 bold"><?php 	echo ""; ?></span></div>
 						<div class="mother xs-down-3"><button type="submit" name="sign_up" class="sign_up_btn">Log In</button></div>
 						<div class="centered mother xs-down-1"><span class="faded px13">Forgotten password? <a href="" class="color-code-2 bold">recover password</a></span></div>
 						<div class="centered mother xs-down-1"><span class="faded px13">I don't have an account <a href="signup.php" class="color-code-2 bold">Sign up</a></span></div>
 					</form>
			</div>
		</div>
	</div>
